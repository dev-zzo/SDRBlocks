...
namespace SDRBlocks.Core
{
    ...
    public static class FastMath
    {
        ...
        {
            return ((uint)bitReverseLUT[x & 0xff] << 24) |
                ((uint)bitReverseLUT[(x >> 8) & 0xff] << 16) |
                ((uint)bitReverseLUT[(x >> 16) & 0xff] << 8) |
                ((uint)bitReverseLUT[(x >> 24) & 0xff]);
        }
        ...
        private static readonly byte[] bitReverseLUT = 
        {
